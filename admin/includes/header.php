      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="add_news_event.php" class="nav-link">
                  <i class="nav-icon fa fa-circle-o text-warning"></i>
                  <p>Add News &amp; Event</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="post_article.php" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="add_healthcare.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon text-warning"></i>
                  <p>Add স্বাস্থ্যকথা</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="post_healthcare.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon text-info"></i>
                  <p>View স্বাস্থ্যকথা</p>
                </a>
              </li>
            </ul>
          </li>
